...
class MetadataStore(base.AiPlatformResourceNounWithFutureManager):
    ...
    def __init__(
        ...
        Args:
            metadata_store_name (str):
                Optional. A fully-qualified MetadataStore resource name or ID.
                Example: "projects/123/locations/us-central1/MetadataStore/default" or
                "default" when project and location are initialized or passed.
    ...
    def create(
        ...
        return cls(
            metadata_store_name=created_metadata_store.name,
            project=project,
            location=location,
